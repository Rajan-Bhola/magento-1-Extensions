...
class Amasty_Checkoutfees_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function calculateTax($amount, Mage_Sales_Model_Quote $quote){
        $taxClassId = Mage::getStoreConfig('amcheckoutfees/general/checkoutfees_tax_class');
        ...
        $checkoutFeeTaxAmount = $amount * ($currentTax/100);
        return $checkoutFeeTaxAmount;
    }
}