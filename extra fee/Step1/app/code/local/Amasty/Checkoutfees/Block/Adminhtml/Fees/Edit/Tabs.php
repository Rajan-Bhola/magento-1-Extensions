...
class Amasty_Checkoutfees_Block_Adminhtml_Fees_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('calculation', array(
                'label'   => Mage::helper('amcheckoutfees')->__('Calculation'),
                'content' => $this->getLayout()->createBlock('amcheckoutfees/adminhtml_fees_edit_tab_calculation')
                    ->setTitle('Conditions')
                    ->toHtml(),
            )
        );
