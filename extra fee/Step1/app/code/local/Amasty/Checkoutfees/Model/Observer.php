...
class Amasty_Checkoutfees_Model_Observer
{
     ...
     * @return bool
     */
    public function afterShippingMethodSave($observer)
    {
        if (!Mage::registry('amasty_checkoutfees_afterShippingMethodSave')) {
            // save global var to prevent infinite loop
            Mage::register('amasty_checkoutfees_afterShippingMethodSave', true, true);
            ...
            // remove processing flag
            Mage::unregister('amasty_checkoutfees_afterShippingMethodSave');
        }
    }
